...
> = {
  WORK010: React.lazy(ROUTE_INFRA_IMPORTERS.WORK010),
  WORK020: React.lazy(ROUTE_INFRA_IMPORTERS.WORK020),
  WORK040: React.lazy(ROUTE_INFRA_IMPORTERS.WORK040),
  WORK050: React.lazy(ROUTE_INFRA_IMPORTERS.WORK050),
  INFRASYS010: React.lazy(ROUTE_INFRA_IMPORTERS.INFRASYS010),
  INFRASYS020: React.lazy(ROUTE_INFRA_IMPORTERS.INFRASYS020),
